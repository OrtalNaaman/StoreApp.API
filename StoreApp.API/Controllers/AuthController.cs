...
namespace StoreApp.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<UserTokenDTO?> VerifyRefreshToken(UserTokenDTO request)
        {
            ...
            var tokenContent = jsonSecurityTokenHandler.ReadJwtToken(request.Token);
...

        {
            ...
            var token = new JwtSecurityToken(
                ...
                claims: claims,
                expires: DateTime.Now.AddDays(Convert.ToInt16(_config["JwtSettings:DurationInMinutes"])),
